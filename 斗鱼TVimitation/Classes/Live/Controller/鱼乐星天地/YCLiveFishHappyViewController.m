//
//  YCLiveFishHappyViewController.m
//  斗鱼TVimitation
//
...
@interface YCLiveFishHappyViewController () <YCLiveTopViewDelegate>
...
@implementation YCLiveFishHappyViewController
...
- (void)liveTopView:(YCLiveTopView *)topView didClickButtonTitle:(NSString *)title {
    NSString *url = [NSString stringWithFormat:@"http://capi.douyucdn.cn/api/v1/getColumnRoom/2?aid=ios&client_sys=ios&limit=20&offset=%d&time=1469009220&auth=cfde7142646e9d6305ae3a37e0e3c176",self.ofset];
    self.url = url;
    [self.collectionView.mj_header beginRefreshing];
}
